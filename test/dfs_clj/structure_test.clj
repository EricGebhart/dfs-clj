(ns dfs-clj.structure-test
  (:require [dfs-clj.fakes.structure :as fakes]
            [dfs-clj.serializer :as serializer]
            [dfs-clj.partitioner :as partitioner])
  (:import [com.backtype.hadoop.pail PailStructure]
           [dfs-clj.partitioner NullPartitioner]
           [dfs-clj.fakes.structure DefaultPailStructure FakePailStructure FakeSerializer FakePartitioner UnserializableStateStructure]
